...
<template>
  <ul class="mb-[40px] text-[0] tracking-[-.4em] text-center">
    <li v-for="season in seasons" class="group peer peer-[]:ml-[10px] inline-block relative w-[434px] align-top font-extrabold text-[20px] font-montserrat tracking-[.04em] [-webkit-text-stroke:_1px_#000]
