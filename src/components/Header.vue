...
<template>
  <header class="relative w-[218px] pt-[5px] bg-white
    ...
    <div class="hidden max-md:block">
      ...
      <div class="max-md:fixed max-md:top-[10px] max-md:right-[3.5%] max-md:z-[11]">
        ...
        <ul
          ...
          <li
            class="max-md:absolute max-md:top-1/2 max-md:left-1/2 max-md:translate-x-[-50%] max-md:translate-y-[-50%] max-md:w-full max-md:h-[2px] max-md:bg-white">
          </li>
          <li
    ...
    <div class="relative w-[207px] h-screen min-h-[1073px] my-0 mx-auto pt-[13px] pb-[333px] px-0
        max-md:hidden max-md:fixed max-md:top-0 max-md:right-0 max-md:bottom-0 max-md:left-0 max-md:z-10 max-md:w-full max-md:h-full max-md:p-0 max-md:overflow-y-auto
