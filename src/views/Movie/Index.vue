...
<template>
  <AppLayout v-bind="layoutProps" :style="`--my-color-var: var(${color})`">
    ...
    max-md:mb-[18px] max-md:text-center">
      <ul>
        <li class="peer peer-[]:ml-[29px] relative inline-block align-top tracking-normal current
            ...
            max-md:peer-[]:ml-[5%]">
          <a href="./" class="block w-full h-full text-black font-semibold text-[16px] font-montserrat tracking-[.13em] no-underline
            max-md:text-[14px] max-md:tracking-[.075em]">ALL</a>
        </li>
        <li class="peer peer-[]:ml-[29px] relative inline-block align-top tracking-normal
            ...
            [&.current]:before:opacity-100 [&.current]:before:w-full [&.current]:before:[transition:_all_0.7s_cubic-bezier(0.23,_1,_0.32,_1)]
            max-md:peer-[]:ml-[5%]">
          <a href="./?category=Anime" class="block w-full h-full text-black font-semibold text-[16px] font-montserrat tracking-[.13em] no-underline
            max-md:text-[14px] max-md:tracking-[.075em]">Anime</a>
        </li>
        <li class="peer peer-[]:ml-[29px] relative inline-block align-top tracking-normal
            before:box-content before:opacity-0 before:absolute before:bottom-[-6px] before:left-[-2.5px] before:w-0 before:h-[2px] before:border-2 before:border-solid before:border-black before:leading-[1px] before:bg-[var(--my-color-var)]
            before:[transition:_all_0.7s_cubic-bezier(0.23,_1,_0.32,_1)]
            ...
            [&.current]:before:opacity-100 [&.current]:before:w-full [&.current]:before:[transition:_all_0.7s_cubic-bezier(0.23,_1,_0.32,_1)]
            max-md:peer-[]:ml-[5%]">
          <a href="./?category=Study" class="block w-full h-full text-black font-semibold text-[16px] font-montserrat tracking-[.13em] no-underline
            max-md:text-[14px] max-md:tracking-[.075em]">Study</a>
        </li>
      </ul>
    </nav>

    <ul class="text-[0] tracking-[-.4em] opacity-0 translate-y-[25px] effect_item
     ...
     max-md:translate-y-[15px] max-md:[&.active]:translate-y-0">
      <li v-for="movie in movies" class="group inline-block w-[393px] mb-[38px] align-top text-[16px] tracking-normal cursor-pointer even:ml-[60px]
        max-md:w-[94%] max-md:mb-[26px] max-md:even:ml-0" @click="(selectedVideoId = movie.videoId, showModal = true)">
        <div class="relative w-full pt-[56.5%]
          ...
          max-md:pt-[59.5%]
          max-md:before:top-[18px] max-md:before:left-[6%]">
          <div class="absolute top-0 left-0 w-full h-full overflow-hidden">
            <div class="absolute top-0 left-0 w-full h-full bg-center bg-cover bg-no-repeat origin-center before:bg-[var(--my-color-var)]
        ...
        <div class="inline-block relative max-w-full mt-[35px] align-top font-semibold text-[13px] leading-[1.3em] tracking-[.075em]
          ...
          max-md:mt-[28px] max-md:text-[12px]">
